...
class NetworkManager {
  ...
  ///[ header] 外加头
  ///[ option] 配置
  static get(url, params, Map<String, String> header, Options option, {noTip = false}) async {
...
//      }
    ...
    try {
      ...
      return new ResultData(null, errorResponse.statusCode, 'reques fail', false);
    }
    ...
    try {
      if (option.contentType != null && option.contentType.primaryType == "text") {
        return new ResultData(response.data, response.statusCode, '', true);
